...
```powershell
python mercurio-examples/model-graph-analysis/analyze_model_d3.py --backend-url http://127.0.0.1:49152
```
...
```powershell
python mercurio-examples/model-graph-analysis/analyze_model_d3.py --executable mercurio-product/target/debug/mercurio-console-api.exe
```

The script writes:

```text
mercurio-examples/model-graph-analysis/out/decision-review.html
```
